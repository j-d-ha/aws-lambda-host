...
///     <see cref="Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyRequest" /> and provides a foundation
...
/// </remarks>
public abstract class ApiGatewayV2RequestEnvelopeBase<T> : APIGatewayHttpApiV2ProxyRequest, IRequestEnvelope
{
