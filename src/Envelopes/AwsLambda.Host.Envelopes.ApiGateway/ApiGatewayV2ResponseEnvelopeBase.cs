...
///     <see cref="Amazon.Lambda.APIGatewayEvents.APIGatewayHttpApiV2ProxyResponse" /> and provides a foundation
...
/// </remarks>
public abstract class ApiGatewayV2ResponseEnvelopeBase<T> : APIGatewayHttpApiV2ProxyResponse, IResponseEnvelope
{
