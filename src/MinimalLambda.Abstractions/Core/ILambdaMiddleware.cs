...
/// <remarks>
///     <para>
///         Middleware components are invoked in sequence during each Lambda invocation. Each
///         middleware can perform operations before and after calling the next delegate to continue
///         the pipeline. Register middleware using <c>UseMiddleware&lt;T&gt;()</c>. Constructor
///         parameters can be annotated with <see cref="FromArgumentsAttribute" />,
///         <see cref="FromServicesAttribute" />, or <c>FromKeyedServicesAttribute</c>. Use
