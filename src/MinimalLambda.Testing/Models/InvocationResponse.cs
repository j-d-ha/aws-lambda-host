...
/// <remarks>
///     <para>
///         This class serves as the non-generic base for
///         <see cref="InvocationResponse{TResponse}" />, providing common properties for all
///         invocation results regardless of the response type. It contains the
///         <see cref="WasSuccess" /> flag and <see cref="Error" /> information that are shared across
///         all invocation responses.
///     </para>
///     <para>
...
{
    /// <summary>
    ///     Gets the error information if the Lambda function invocation failed, or
    ///     <see langword="null" /> if the invocation succeeded.
    /// </summary>
    /// <value>
    ///     An <see cref="ErrorResponse" /> containing error details, or <see langword="null" /> for
    ...
    /// <summary>Gets a value indicating whether the Lambda function invocation completed successfully.</summary>
    /// <value>
    ...
    ///     <see langword="false" /> if the invocation failed and <see cref="Error" /> contains error
    ///     information.
    /// </value>
    /// <remarks>
